...
import { 
    ...
    FileText, X, ChevronRight, PieChart, TrendingUp, MapPin
} from 'lucide-react';
...
export const DashboardView = ({ 
    ...
    return (
        <div className="fade-in pb-20 relative">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 p-1.5 bg-black/5 dark:bg-white/5 border theme-border rounded-xl w-full md:w-fit mb-8 shadow-inner">
                <button 
